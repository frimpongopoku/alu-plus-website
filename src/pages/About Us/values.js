import and from "./../../assets/media/android.png";
import ios from "./../../assets/media/ios.png";
import react from "./../../assets/media/react.png";
import vue from "./../../assets/media/vue.png";
import sec from "./../../assets/media/sec.png";
import php from "./../../assets/media/php.png";
import py from "./../../assets/media/py.png";
import algo from "./../../assets/media/algo.png";
export const COURSES = [
  ...
  },
  {
    ...
    tag: "computing",
    text: `
    Take a deep dive into android development, IOS development, Frontend (React, Vue etc) development, Backend development( PHP, Django[python] etc) Algorithms and
    Security at the African Leadership University. 
    ...
    courses: [
      [
        ...
        {
          name: "React Development - Frontend",
          img: react,
        },
      ],
